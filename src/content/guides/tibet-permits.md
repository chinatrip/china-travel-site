...
verified_against:
  - https://www.chinahighlights.com/tibet/visa-document.htm
  - https://www.gototibet.com/blog/can-foreigners-go-to-tibet
sources:
  - raw/tibet-travel-guide-2026.md
related:
  - wiki/concepts/visa-types.md
  - wiki/concepts/health-medical.md
  - wiki/concepts/emergency-safety.md
  - wiki/concepts/trip-planning.md
volatility: medium
review:
  status: audited
...
## Tibet Travel Permit (TTT) — Who Needs It
...
## How to Obtain the TTT

**Independent applications are not permitted.** Process:

1. Book a Tibet tour through a **licensed Chinese travel agency** — the agency submits the permit application on your behalf
2. Hold a valid China visa or qualify for visa-free entry (78 countries as of 2026 — see [[wiki/concepts/visa-types.md]])
3. Submit passport copy + China visa / entry-record copy to the agency
4. Allow **at least 10 working days** before your travel date (processing takes 5–7 working days)
5. Train passengers receive a permit copy; those flying to Lhasa need the **original permit**
...
This is legally distinct from mainland China, where independent foreign travel is generally unrestricted — see [[wiki/concepts/trip-planning.md]].

## When Tibet Is Closed to Foreign Tourists
...
- [[wiki/concepts/visa-types.md]] — Visa-free entry eligibility, China tourist (L) visa
- [[wiki/concepts/trip-planning.md]] — Independent vs. guided travel in mainland China; when to visit
- [[wiki/concepts/health-medical.md]] — General health and hospital guidance; travel insurance
- [[wiki/concepts/emergency-safety.md]] — Emergency contacts and evacuation procedures
